import numpy as np
from black_boxes.forgetful_ucb import *
import random
...
def run_forgetful_doubler_algorithm(arms, n_arms, log_horizon, means):
...
def run_several_iterations(iterations, arms, n_arms, horizon, means):
    ...
    for iteration in range(iterations):
        ...
        results += run_forgetful_doubler_algorithm(arms, n_arms, log_horizon=log_horizon, means=means)
...
def run_several_iterations_and_save_results(algorithm, iterations, arms, n_arms, horizon, means, data_type):
    ...
    for iteration in range(iterations):
        ...
        # The current cumulative regret.
        result[:, iteration] = run_forgetful_doubler_algorithm(arms, n_arms, log_horizon, means)
