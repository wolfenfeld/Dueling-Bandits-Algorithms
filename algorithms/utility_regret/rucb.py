...
def run_rucb_algorithm(arms, n_arms, horizon, means):
    ...
    for t in range(horizon):
        ...
        average_reward[t] = (right_reward + left_reward) / (2+.0)
...
def run_several_iterations(iterations, real_arms, n_arms, horizon, means):
    ...
    for iteration in range(iterations):
        ...
        # Adding the regret.
        results += run_rucb_algorithm(real_arms, n_arms, horizon, means)
...
def run_several_iterations_and_save_results(algorithm, iterations, arms, n_arms, horizon, means, data_type):
    ...
    for iteration in range(iterations):
        ...
        result[:, iteration] = run_rucb_algorithm(arms, n_arms, horizon, means)
