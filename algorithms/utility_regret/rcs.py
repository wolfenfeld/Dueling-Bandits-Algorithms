...
def run_rcs_algorithm(arms, n_arms, horizon, means):
...
def run_several_iterations(iterations, arms, n_arms, horizon, means):
    ...
    for iteration in range(iterations):
        ...
        # Adding the regret.
        results += run_rcs_algorithm(arms, n_arms, horizon, means)
...
def run_several_iterations_and_save_results(algorithm, iterations, arms, n_arms, horizon, means, data_type):
    ...
    for iteration in range(iterations):
        ...
        result[:, iteration] = run_rcs_algorithm(arms, n_arms, horizon, means)
